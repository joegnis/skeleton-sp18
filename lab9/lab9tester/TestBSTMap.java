...
public class TestBSTMap {
    ...
    @Test
    public void removeKVTest() {
        BSTMap<String, Integer> bst = new BSTMap<>();
        bst.put("hi", 1);
        assertNull(bst.remove("hi", 2));
        assertEquals(1, bst.remove("hi", 1));
        assertNull(bst.get("hi"));
        ...
        bst.put("hi4", 4);
        bst.put("hi8", 8);
        assertNull(bst.remove("hi4", 3));
        assertEquals(4, bst.remove("hi4", 4));
        assertNull(bst.get("hi4"));
        ...
        bst.put("hi4", 4);
        bst.put("hi8", 8);
        assertNull(bst.remove("hi6", 7));
        assertEquals(6, bst.remove("hi6", 6));
        assertNull(bst.get("hi6"));
        ...
        bst.put("hi40", 40);
        bst.put("hi34", 34);
        assertNull(bst.remove("hi33", 35));
        assertEquals(33, bst.remove("hi33", 33));
        assertNull(bst.get("hi33"));
        ...
        bst.put("hi40", 40);
        bst.put("hi34", 34);
        assertNull(bst.remove("hi40", 32));
        assertEquals(40, bst.remove("hi40", 40));
        assertNull(bst.get("hi40"));
    }
